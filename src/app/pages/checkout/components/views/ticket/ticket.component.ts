      ...
      <div class="limited-container py-16">
        ...
        <div class="ticket-details bg-[#FFECF0] px-7 py-5 rounded-lg flex flex-col lg:flex-row gap-5 lg:gap-3 justify-between items-start lg:items-center">
          <div class="event-details max-w-[476px] flex flex-col gap-5 lg:gap-3">
            <h4 class="text-xl leading-[120%]">Mulheres e as tecnologias</h4>
            <p class="text-(color:--secondary) !font-['Montserrat'] text-sm leading-[120%] -tracking-[2%]">
          ...
          <div class="quantity flex gap-7 items-center">
            ...
            <app-custom-number-input name="quantity" [(ngModel)]="quantity" [min]="1" [max]="99" />
          </div>
          <div class="total w-full min-w-[257px] lg:w-fit flex gap-5 items-center">
              <p class="type text-base !font-['Montserrat']">Total: </p>
              <p class="price font-bold !font-['Inter] text-2xl">{{ 5000 * quantity | aoMoneyFormat }} KZ</p>
          </div>
        </div>
